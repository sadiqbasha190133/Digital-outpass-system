...
const mailer = (email, generatedOTP) => {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'OTP for user verification',
      html: `<h2>OTP for user verification</h2>
             <p>Dear user, your OTP for email verification for ${email} is:</p>
             <h3>${generatedOTP}</h3>
             <p>Use this otp to verify your email and get registered to our Outpass Portal.
             <br>Please do not share this OTP with anyone for security reasons.
             <br>Thank You</p><br>
