...
//     console.log("outpass details: ", outpassDetails)
...
const PreviousOutpassDetails = () => {
    ...
    const from = new Date(outpassDetails.fromDate);
    const fromDate = from.toISOString().slice(0, 10); // Correct format

    const to = new Date(outpassDetails.toDate);
    const toDate = to.toISOString().slice(0, 10); // Correct format
