        ...
        <div className="fp-box">
            {
                isOtpSub ? (
                    ...
                    <form className="fp-form" onSubmit={handleSubmit}>
                        ...
                        <input type="text" name="enroll" id='enroll' className="fp-inp fp-up" placeholder='eg. R190001' onChange={(e) => {setEnrollment(e.target.value.toUpperCase())}} required/>
                        <label htmlFor="email" className="fp-label">Enter your Email Id:</label>
                        <input type="email" name='email' id='email' className="fp-inp" placeholder='eg. r190001@rguktrkv.ac.in' onChange={(e) => {setEmail(e.target.value)}} required/>
                        {isDetailSub &&
                            <>
